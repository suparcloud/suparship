...
- **Internal ChartMuseum:** `https://chartmuseum.internal.azure.biglysalesshared.com`
...
- **`suparship-common` dependency** in an external repo's
  ...
  dependencies:
    - name: suparship-common
      ...
      repository: "https://chartmuseum.internal.azure.biglysalesshared.com"
  ```

  Pin to an explicit version. Run `helm repo add suparship-common
  https://chartmuseum.internal.azure.biglysalesshared.com && helm
...
2. Push to the internal ChartMuseum:
   ...
   curl --data-binary "@<name>-<version>.tgz" \
     https://chartmuseum.internal.azure.biglysalesshared.com/api/charts
   ```
...
3. Edit `templates/<name>/template.yaml` → bump `metadata.version` and
   ...
   `https://chartmuseum.internal.azure.biglysalesshared.com`.
4. Commit and push.
